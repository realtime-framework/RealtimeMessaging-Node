            ...
            if (ortc.sockjs != null) {
                ...
                if (userPerms && userPerms != null && !hashPerm) {
                    ...
                    if (subscribedChannels[channel]) {
                        ...
                        subscribedChannels[channel] = { 'isSubscribing': true, 'isSubscribed': false, 'subscribeOnReconnected': subscribeOnReconnected, 'onMessageWithFilterCallback': onMessageWithFilterCallback };
                    }
                    if(ortc.sockjs && ortc.sockjs.isConnected){
